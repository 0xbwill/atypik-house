...
<head>
  ...
  <![endif]-->
  <title>Equipement supprimé</title>
  <style>
    img {
      max-width: 100%;
...
<body style="margin: 0; width: 100%; padding: 0; -webkit-font-smoothing: antialiased; word-break: break-word">
  <div role="article" aria-roledescription="email" aria-label="Equipement supprimé" lang="en">
    <div style="width: 100%">
      <div style="margin-left: auto; margin-right: auto; max-width: 336px; border-radius: 8px; background-color: #fff; padding: 24px; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -4px rgba(0, 0, 0, 0.1)">
        ...
        <p style="margin-top: 16px; font-size: 18px">Un nouvel équipement a été supprimé d'une catégorie :</p>
